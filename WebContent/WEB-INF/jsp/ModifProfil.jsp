...
<form action="<%=request.getContextPath()%>/ModifProfil" method="post">
	...
	<input type="text" name="prenom" id="prénom" placeholder="saisir votre nouveau prénom" value="<jsp:getProperty property="prenom" name="utilisateur"/>"/></h2>
	...
	<input type="tel" name="telephone" id="téléphone" placeholder="saisir votre nouveau n° de téléphone" value="<jsp:getProperty property="telephone" name="utilisateur"/>"/></h2>
	
	<h2><label for="adresse">Adresse</label>
	<input type="text" name="rue" id="adresse" placeholder="saisir vos nouveaux n° et nom de rue" value="<jsp:getProperty property="rue" name="utilisateur"/>"/></h2>
	
	<h2><label for="codepost">Code Postal</label>
	<input type="text" name="codePostal" id="codepost" placeholder="saisir votre nouveau code postal" value="<jsp:getProperty property="codePostal" name="utilisateur"/>"/></h2>
	...
	<input type="password" name="motDePasse" id="mdp" placeholder="saisir votre nouveau mot de passe"/></h2>
